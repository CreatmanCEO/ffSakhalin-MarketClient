...
import 'cart_veb_model.dart';
export 'cart_veb_model.dart';

class CartVebWidget extends StatefulWidget {
  const CartVebWidget({super.key});

  @override
  State<CartVebWidget> createState() => _CartVebWidgetState();
}

class _CartVebWidgetState extends State<CartVebWidget> {
  late CartVebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartVebModel());

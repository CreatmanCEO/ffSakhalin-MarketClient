...
import 'popup_order_info_model.dart';
export 'popup_order_info_model.dart';

class PopupOrderInfoWidget extends StatefulWidget {
  const PopupOrderInfoWidget({
    super.key,
  ...
  @override
  State<PopupOrderInfoWidget> createState() => _PopupOrderInfoWidgetState();
}

class _PopupOrderInfoWidgetState extends State<PopupOrderInfoWidget> {
  late PopupOrderInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopupOrderInfoModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if ((widget!.currentOrder?.status == 'Выполнен') ||
                        (widget!.currentOrder?.status == 'Создан'))
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            0.0, 25.0, 0.0, 15.0),
                        child: FFButtonWidget(

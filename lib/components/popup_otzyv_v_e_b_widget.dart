...
import 'popup_otzyv_v_e_b_model.dart';
export 'popup_otzyv_v_e_b_model.dart';

class PopupOtzyvVEBWidget extends StatefulWidget {
  const PopupOtzyvVEBWidget({super.key});

  @override
  State<PopupOtzyvVEBWidget> createState() => _PopupOtzyvVEBWidgetState();
}

class _PopupOtzyvVEBWidgetState extends State<PopupOtzyvVEBWidget> {
  late PopupOtzyvVEBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopupOtzyvVEBModel());

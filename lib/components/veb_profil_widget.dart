...
import 'veb_profil_model.dart';
export 'veb_profil_model.dart';

class VebProfilWidget extends StatefulWidget {
  const VebProfilWidget({super.key});

  @override
  State<VebProfilWidget> createState() => _VebProfilWidgetState();
}

class _VebProfilWidgetState extends State<VebProfilWidget> {
  late VebProfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VebProfilModel());

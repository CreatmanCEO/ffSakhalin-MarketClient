...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF84F0E);
  late Color secondary = const Color(0x4DF9FBA5);
  late Color tertiary = const Color(0xCBFFFFFF);
  late Color alternate = const Color(0xFF00FFAC);
  late Color primaryText = const Color(0xFF32343E);
  ...
  late Color itemBorder = Color(0xFFF6AA8E);
}

...
import 'category_web_model.dart';
export 'category_web_model.dart';
...
class _CategoryWebWidgetState extends State<CategoryWebWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryWebModel());
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 25.0, 0.0, 19.0),
                            child: FutureBuilder<List<CartItemsRecord>>(
                                ...
                                builder: (context) {
                                  final listRest = functions
                                      .newfilterRestaurantsByName(
                                          mobhomeRestoranRecordList.toList(),
                                          _model.sortName!,
                                          _model.sortRatinr!,
                                          _model.filtrCartPay!,
                                          _model.filtrSamovivos!)
                                  ...
                                  return GridView.builder(
                                    ...
                                    itemBuilder: (context, listRestIndex) {
                                      final listRestItem =
                                          listRest[listRestIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 10.0),
                                        child: Container(
                                                      ...
                                                      children: [
                                                        Align(
                                                          ...
                                                          child:
                                                            ...
                                                            key: Key(
                                                                'Keyqwp_${listRestIndex}_of_${listRest.length}'),
                                                            restoran:
                                                                listRestItem,
                                                          ),
                                                        ),
                                                            ...
                                                            AuthUserStreamWidget(
                                                              builder: (context) =>
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  if (loggedIn) {
                                                                    if ((currentUserDocument?.favorit?.toList() ??
                                                                            [])
                                                                        .contains(

...
import 'info_closed_model.dart';
export 'info_closed_model.dart';

class InfoClosedWidget extends StatefulWidget {
  const InfoClosedWidget({
    super.key,
  ...
  @override
  State<InfoClosedWidget> createState() => _InfoClosedWidgetState();
}

class _InfoClosedWidgetState extends State<InfoClosedWidget> {
  late InfoClosedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoClosedModel());

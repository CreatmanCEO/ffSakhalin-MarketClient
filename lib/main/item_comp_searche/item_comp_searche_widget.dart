...
import 'item_comp_searche_model.dart';
export 'item_comp_searche_model.dart';

class ItemCompSearcheWidget extends StatefulWidget {
  const ItemCompSearcheWidget({
    super.key,
  ...
  @override
  State<ItemCompSearcheWidget> createState() => _ItemCompSearcheWidgetState();
}

class _ItemCompSearcheWidgetState extends State<ItemCompSearcheWidget> {
  late ItemCompSearcheModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemCompSearcheModel());
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: widget!.blockMenu!.image.first,
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Montserrat',
                          fontSize: MediaQuery.sizeOf(context).width < 375.0
                              ? 12.0
                              : 14.0,
                          letterSpacing: 0.0,
                          fontWeight: FontWeight.w500,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Icon(
                                ...
                                size: MediaQuery.sizeOf(context).width < 375.0
                                    ? 14.0
                                    : 20.0,
                              ),
                            ].divide(SizedBox(width: 3.0)),
                              ...
                              onPressed: () async {
                                if (loggedIn) {
                                  if (widget!.blockMenu?.reference !=
                                    ...
                                    if (widget!.blockMenu!.options.isNotEmpty) {
                                      ...
                                      await CartItemsRecord.collection
                                        ...
                                        ...createCartItemsRecordData(
                                          ...
                                          ves: containerCartItemsRecord?.ves,
                                          kkal: widget!.blockMenu?.kkal,
                                          b: containerCartItemsRecord?.b,
                                          zh: widget!.blockMenu?.zh,
                                          u: widget!.blockMenu?.u,
                                          oldPrise: widget!.blockMenu?.oldPrice,
                                          restoran: widget!.blockMenu?.restoran,
                                          product: widget!.blockMenu?.reference,
                                          quantity: 1,
                                          user: currentUserReference,
                                          totalPrise: widget!.blockMenu?.price,
                                          restoranname:
                                              widget!.blockMenu?.restoranName,
                                        ),
                                        ...mapToFirestore(
                                          {
                                            ...
                                            'image': widget!.blockMenu?.image,
                                          },
                                        ),
                                      });
                                    }
                                  } else {
                                    await containerCartItemsRecord!.reference
                                        .delete();
                                  }
                                } else {
                                  await showModalBottomSheet(

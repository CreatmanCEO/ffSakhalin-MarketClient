...
import 'item_web_model.dart';
export 'item_web_model.dart';

class ItemWebWidget extends StatefulWidget {
  const ItemWebWidget({
    super.key,
  ...
  @override
  State<ItemWebWidget> createState() => _ItemWebWidgetState();
}

class _ItemWebWidgetState extends State<ItemWebWidget> {
  late ItemWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemWebModel());
                      ...
                      child: FutureBuilder<List<RestoranRecord>>(
                        future: queryRestoranRecordOnce(
                          queryBuilder: (restoranRecord) =>
                            ...
                            'name',
                            isEqualTo: widget!.currentTovar?.restoranName,
                          ),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          final containerRestoranRecord =
                              containerRestoranRecordList.isNotEmpty
                                  ? containerRestoranRecordList.first
                                  : null;
                                  ...
                                  child: FlutterFlowExpandedImageView(
                                    image: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          Duration(milliseconds: 500),
                                      imageUrl:
                                          widget!.currentTovar!.image.first,
                                      fit: BoxFit.contain,
                                    ),
                                    allowRotation: false,
                                    tag: widget!.currentTovar!.image.first,

...
class AddAdressModel extends FlutterFlowModel<AddAdressWidget> {
  ...
  String? _textFieldPodTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Укажите номер подъезда';
    }
  ...
  String? _textFieldKVTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
  ...
  String? _textFieldDomFonTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Если домофона нет, поставьте 0';
    }
  ...
  void initState(BuildContext context) {
    ...
    textFieldPodTextControllerValidator = _textFieldPodTextControllerValidator;
    textFieldKVTextControllerValidator = _textFieldKVTextControllerValidator;
    textFieldDomFonTextControllerValidator =
        _textFieldDomFonTextControllerValidator;
  }

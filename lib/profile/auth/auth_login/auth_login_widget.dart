...
class _AuthLoginWidgetState extends State<AuthLoginWidget> {
  ...
  void initState() {
    ...
    _model.textFieldmailMTextController ??= TextEditingController();
    _model.textFieldmailMFocusNode ??= FocusNode();

    _model.textFieldmailTextController ??= TextEditingController();
    _model.textFieldmailFocusNode ??= FocusNode();

    _model.textFieldMTextController ??= TextEditingController();
    _model.textFieldMFocusNode ??= FocusNode();
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .textFieldmailMTextController,
                                                    focusNode: _model
                                                        .textFieldmailMFocusNode,
                                                    onChanged: (_) =>
                                                        EasyDebounce.debounce(
                                                      '_model.textFieldmailMTextController',
                                                      Duration(
                                                          milliseconds: 2000),
                                                      () => setState(() {}),
                                                    ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .textFieldMTextController,
                                                        focusNode: _model
                                                            .textFieldMFocusNode,
                                                        autofocus: true,
                                                        obscureText: !_model
                                                            .textFieldMVisibility,
                                                        decoration:
                                                            InputDecoration(
                                                          isDense: false,
                                                          hintText:
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .primary,
                                                        validator: _model
                                                            .textFieldMTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                          ...
                                          if (currentUserEmailVerified) {
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  content: Text(
                                                      'Для хода, подтвердите своей Email'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                          ...
                                          if (currentUserEmailVerified) {
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  content: Text(
                                                      'Для входа, подтвердите своей Email'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed('Auth_register');
                                          },
                                          child: Text(
                                            '  Регистрация',
                                            style: FlutterFlowTheme.of(context)

...
import 'logout_bottom_sheet_model.dart';
export 'logout_bottom_sheet_model.dart';
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: Text(
                                        'Хотите выйти из вашей учетной записи?',
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          FFAppState().productInCart = [];
                                          FFAppState().cartItems = [];
                                          FFAppState().uniqueRestaurants = [];
                                          FFAppState().currentUserAdress = null;

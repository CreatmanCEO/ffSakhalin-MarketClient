...
import '/profile/cancel_order/cancel_order_widget.dart';
...
export 'current_order_model.dart';
...
class _CurrentOrderWidgetState extends State<CurrentOrderWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentOrderModel());

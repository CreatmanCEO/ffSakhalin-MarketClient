  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AdressUserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdressUserRecord> myAddressesAdressUserRecordList = snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final userAdress =
                                                myAddressesAdressUserRecordList
                                                    .toList();
                                      ...
                                      if (myAddressesAdressUserRecordList
                                              .length >=
                                          2)
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 0.0, 10.0, 0.0),
                                          child: Text(
                                            'Выберите активный адрес и нажмите сохранить выбор',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Montserrat',
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        if (FFAppState().userAdres != null &&
                                            FFAppState().userAdres != '') {
                                          await currentUserReference!
                                              .update(createUserRecordData(
                                            adres: FFAppState().userAdres,
                                            adresStroke:
                                                FFAppState().UserAdressStroke,
                                          ));
                                          await actions

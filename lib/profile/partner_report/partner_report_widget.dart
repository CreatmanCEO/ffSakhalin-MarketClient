...
import 'partner_report_model.dart';
export 'partner_report_model.dart';

class PartnerReportWidget extends StatefulWidget {
  const PartnerReportWidget({super.key});

  @override
  State<PartnerReportWidget> createState() => _PartnerReportWidgetState();
}

class _PartnerReportWidgetState extends State<PartnerReportWidget> {
  late PartnerReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PartnerReportModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Text(
                          'Новая платформа для ваших заказов!',
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.textFieldCompanyFocusNode,
                                autofocus: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: false,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Нажав \"Отправить\", я соглашаюсь на обработку моих персональных данных в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных» и в соответствии с  условиями Правил сервиса',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Montserrat',
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.checkboxValue!) {
                          await PartnersRecord.collection.doc().set({
                            ...createPartnersRecordData(
                              ...
                              company:
                                  _model.textFieldCompanyTextController.text,
                              read: false,
                            ),
                            ...mapToFirestore(
                              {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Ваше сообщение отправлено! Ответ займет некоторое время и поступит на указанный email.',
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                                      fontFamily: 'Montserrat',
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Внимание!'),
                                content: Text(
                                    'Для продолжения, подтвердите согласие на обработку данных'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>

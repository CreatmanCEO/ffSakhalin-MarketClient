...
import 'profil_web_model.dart';
export 'profil_web_model.dart';

class ProfilWebWidget extends StatefulWidget {
  const ProfilWebWidget({super.key});

  @override
  State<ProfilWebWidget> createState() => _ProfilWebWidgetState();
}

class _ProfilWebWidgetState extends State<ProfilWebWidget> {
  late ProfilWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilWebModel());

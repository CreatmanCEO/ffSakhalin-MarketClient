...
import 'profile_new_order_widget.dart' show ProfileNewOrderWidget;
...
class ProfileNewOrderModel extends FlutterFlowModel<ProfileNewOrderWidget> {
  ...
  // State field(s) for DropDownadressM widget.
  String? dropDownadressMValue;
  FormFieldController<String>? dropDownadressMValueController;
  ...
  // State field(s) for DropDownadress widget.
  String? dropDownadressValue;
  FormFieldController<String>? dropDownadressValueController;

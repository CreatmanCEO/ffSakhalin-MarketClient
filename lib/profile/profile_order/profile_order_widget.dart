...
export 'profile_order_model.dart';

class ProfileOrderWidget extends StatefulWidget {
  ...
  @override
  State<ProfileOrderWidget> createState() => _ProfileOrderWidgetState();
}

class _ProfileOrderWidgetState extends State<ProfileOrderWidget> {
  late ProfileOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileOrderModel());
                                    ...
                                    if ((widget!.currentOrder?.status ==
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            if (widget!.currentOrder?.revivew ==
                                                null) {
                                          ...
                                          text: widget!.currentOrder?.revivew ==
                                                  null
                                              ? 'ОЦЕНИТЬ ЗАКАЗ'
                                              : 'ЗАКАЗ ОЦЕНЕН',

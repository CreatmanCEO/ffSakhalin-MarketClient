...
import 'profile_review_list_model.dart';
export 'profile_review_list_model.dart';
...
class _ProfileReviewListWidgetState extends State<ProfileReviewListWidget> {
  late ProfileReviewListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileReviewListModel());
